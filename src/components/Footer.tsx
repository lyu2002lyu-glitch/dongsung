          ...
          <div>
            <div className="relative mt-2">
              ...
              >
                ...
                <option value="https://icheon.newspring.co.kr/Home/Index" className="bg-black text-white">(주)동승골프앤리조트</option>
                <option value="https://sangju.newspring.co.kr/Home/Index" className="bg-black text-white">(주)동승레저</option>
              </select>

...
export default function Subsidiary() {
  const companies = [
    ...
    {
      name: '㈜동승글로벌',
      desc: '동승글로벌은 동대문 종합시장을 기반으로 성장해 온 동승의 사업 경험을 바탕으로 글로벌 섬유·원단 사업을 확대하기 위해 2026년 설립된 해외사업 전문 법인입니다.\n동대문 시장의 우수한 원단과 소재를 해외 시장에 소개하고, 국내 섬유 산업의 경쟁력을 글로벌 시장으로 확장하는 교두보 역할을 수행하고 있습니다.\n동승글로벌은 글로벌 네트워크와 전문적인 소재 유통 역량을 통해 패션 및 섬유 산업의 새로운 가치를 창출해 나가고 있습니다.',
      img: '/b_sub_03.jpg',
      link: '#',
    },
    {

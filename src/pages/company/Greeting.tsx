          ...
          <div className="space-y-10 flex flex-col justify-center">
            ...
            >
              ...
              <div className="text-gray-700 space-y-6 text-body-m leading-relaxed">
                <p>
                  서울의 역사가 녹아있는 변화의 중심지 동대문에서 1969년 설립된 동승은 원단의 메카 동대문종합시장을 시작으로 골프레저, 호텔, 종합리조트, 해외쇼핑몰과 유통업으로 사업을 확장하며 40여 년 동안 건실하고 경쟁력 있는 기업으로 성장해 왔습니다.
                </p>
                <p>
                  동승은 신의경영, 윤리경영, 정도경영의 기업 이념을 바탕으로 설립이래 무차입 경영, 흑자 경영을 이어가며 고객과의 두터운 신뢰를 확보했습니다. 안정적인 재무를 기반으로 새로운 사업 기회를 발굴하고, 우수한 인재 확보와 적극적인 해외 진출을 통해 글로벌 경쟁력을 강화시켜 건강한 성장을 지속할 수 있도록 노력하고 있습니다.
                </p>
                <p>
                  또한, 동승은 세계적인 명품 호텔 JW Marriott Dongdaemun Square Seoul의 오픈을 통해 패션타운 동대문 지역의 활성화에 중추적인 역할을 할 것입니다. 더 나아가 환경과 사회를 생각하는 자연 친화적인 레저 사업을 통해 지역 사회의 아름다운 환경을 보전하고, 신개념 유통서비스를 통해 고객의 건강을 지키고 품격 있는 라이프스타일을 선도하도록 노력하겠습니다.
                </p>
                <p>
                  급변하는 경영 환경 속에서도 지속적으로 성장할 수 있는 기업, 사회와 함께 성장하고 사회를 변화시키는데 앞서가는 기업 동승이 글로벌로 힘차게 나아갈 수 있도록 고객 여러분의 지속적인 관심 부탁드리겠습니다. 패션의 중심에서 레저를 통한 생활의 업그레이드까지, 동승은 고객 여러분께 더욱 가까이 다가설 것을 약속드립니다.
                </p>
                <p>
                  감사합니다.
                </p>

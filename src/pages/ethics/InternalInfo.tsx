  ...
  const chapters = [
      ...
      articles: [
        {
          id: "1",
          title: "제1조(목적)",
          content: "이 규정은 「자본시장과 금융투자업에 관한 법률」(이하 “법”이라 한다) 및 제반 법규에 따른 신속․정확한 공시 및 임원․직원의 내부자거래 방지를 위하여 회사 내부정보의 종합관리 및 적절한 공개 등에 관한 사항을 정함을 목적으로 한다."
        },
        {
          id: "2",
          title: "제2조(용어의 정의)",
      ...
      articles: [
        {
          ...
          content: [
            ...
            "※ 집행임원을 둔 회사의 경우에는 ‘대표이사’를 ‘대표집행임원’으로 수정한다. 이하 같다. (주석 신설 2017.5.23.)"
          ]
        },
        {
          id: "5",
        ...
        },
        {
          ...
          content: [
            ...
            "② 공시책임자 및 대표이사는 제1항에 따른 내부정보의 적시제공을 위해 회사 내의 정보전달 체계를 효율적으로 구축하여야 하며, 필요한 경우 공시의무 사항과 관련된 업무의 결재과정에 공시책임자의 협조를 받도록 할 수 있다. (신설 2017.5.23.)"
          ]
        },
        {
          id: "7-2",
          title: "제7조의2(최대주주 관련 정보의 관리)",
          content: "공시책임자는 최대주주와 관련된 공시 의무사항 및 조회공시 요구사항에 대한 공시업무를 원활히 수행하기 위하여 최대주주에게 관련 사실을 충분히 설명하고 해당 정보를 적시에 전달받을 수 있도록 정보전달 체계를 구축하여야 한다. [본조 신설 2017.5.23.]"
        },
        {
          id: "7-3",
          title: "제7조의3(종속회사 내부정보의 집중)",
          content: [
        ...
        {
          id: "8",
          title: "제8조(내부정보의 사외제공)",
          content: [
            "① 임원․직원이 업무상의 이유로 회사의 거래상 대방․외부감사인․대리인, 회사와 법률자문․경영자문 등의 자문계약을 체결하고 있는 자 등에 대하여 불가피하게 내부정보를 제공해야 하는 경우 공시책임자에게 이에 관한 사항을 보고하여야 한다.",
    ...
    },
    {
      ...
      articles: [
        ...
        {
          id: "9-2",
          title: "제9조의2(공시대상의 확인)",
          content: "이 규정에 따라 공정공시를 포함한 공시의무사항 해당 여부를 판단함에 있어서 공시규정 제6조제1항제4호에 의한 주가 또는 투자판단에 중대한 영향을 미치거나 미칠 수 있는 사항도 포함되도록 주의하여야 한다. [본조 신설 2017.5.23.]"
        },
        {
          id: "10",
          title: "제10조(공시의 실행)",
        ...
        {
          id: "10-2",
          title: "제10조의2(공시의 신속한 이행)",
          content: "공시책임자는 제9조에 따른 공시사항이 발생한 경우 공시규정에 따른 공시시한 전이라도 해당 내부정보가 적시에 공시될 수 있도록 최선의 노력을 다하여야 한다. [본조 신설 2017.5.23.]"
        },
        {
          id: "11",
          title: "제11조(공시 후의 사후조치)",
          content: "공시책임자와 공시담당자는 공시한 내용에 오류나 누락이 있거나 취소 또는 변경하고자 하는 경우 지체 없이 공시규정 제30 조에 따라 정정공시하는 등 이를 시정하기 위한 조치를 취하여야 한다. (개정 2017.5.23.)"
        },
        {
          id: "12",
          title: "제12조(언론사의 취재 등)",
          content: [
        ...
        {
          id: "12-2",
          title: "제12조의2(보도내용의 확인)",
          content: "공시책임자․공시담당자 및 내부정보 발생 부서는 언론사 등의 회사 관련 보도내용을 일상적으로 확인하여 사실과 다른 내용이 있는 경우 이를 시정하기 위한 조치를 취하여야 한다. [본조 신설 2017.5.23.]"
        },
        {
          id: "13",
          title: "제13조(기업설명회)",
          content: [
            "① 대표이사는 IR활동이 코스닥시장상장법인의 경영책무 임을 인식하고, 자발적․지속적으로 기업설명회를 개최하여 투자관계자와 신뢰를 구축하기 위해 노력하여야 한다.",
            ...
            "④ 회사의 모든 임원·직원은 기업설명회 과정에서 공정공시 대상정보 중 사전에 공시되지 않은 사항이 공개되지 않도록 주의하여야 한다. [전문개정 2017.5.23.]"
          ]
        },
        {
          id: "13-2",
          ...
          content: [
            ...
            "② 제1항에 따른 확인 결과 당해 풍문이 공시규정에 따른 공시의무사항에 해당하는 경우 관련 정보를 공시하여야 한다. [본조 신설 2017.5.23.]"
          ]
        },
        {
          id: "13-3",
          title: "제13조의3(정보제공 요구)",
          content: [
            ...
            "③ 제1항의 결정에 따라 정보를 제공하는 경우에는 제12조제3항을 준용한다. [본조 신설 2017.5.23.]"
          ]
        }
      ]
    },
    {
      title: "제4장 내부자 거래 등에 대한 규제",
      articles: [
        {
          id: "14",
          title: "제14조(단기매매차익의 반환)",
          content: [
            "① 임원과 법 제172조제1항 및 법 시행령 제194 조가 정하는 직원은 법 제172조제1항의 특정증권등(이하 “특정증권등”이라 한다)을 매수한 후 6개월 이내에 매도하거나 특정증권등을 매도한 후 6개월 이내에 매수하여 이익을 얻은 경우에 그 이익(이하 “단기매매차익”이라 한다)을 회사에 반환하여야 한다.",
        ...
        {
          id: "15",
          title: "제15조(특정증권등의 매매 등에 대한 통보)",
          content: "임원과 법 제172조제1항 및 법 시행령 제194조가 정하는 직원은 특정증권등의 매매, 그 밖의 거래를 하는 경우 그 사실을 공시책임자에게 통보하여야 한다. 다만, 한국거래소 상장법인 임직원 내부자거래 알림서비스(K-ITAS)를 통하여 회사에 통보된 매매내역에 대하여는 이를 공시책임자에게 통보한 것으로 본다. (개정 2022.10.4.)"
        },
        {
          id: "16",
          ...
          content: [
            ...
            "※ 회사는 내부자 등의 미공개정보이용 금지, 단기매매차익반환 등 불공정거래예방 및 지분신고를 위해 한국거래소가 제공하는 “상장법인 임직원 내부자 매매 알림서비스(KRX-Insider Trading Alarm Service)”에 등록하여 제14조부터 제16조까지의 통보 및 보고 등에 활용할 수 있다.(주석 신설 2020.12.16.)"
          ]
        }
      ]
    },
      ...
      articles: [
        {
          ...
          title: "제17조(교육)",
          content: [
            "① 공시책임자와 공시담당자는 공시규정 제36조 및 제44조제5항 에 따른 공시업무에 관한 교육 등을 이수하여야 하고, 공시책임자는 교육내용을 관련 임원․직원에게 알려야 한다.",
        ...
        },
        {
          id: "18",
          title: "제18조(규정의 개폐)",
          content: "이 규정의 개정 또는 폐지는 대표이사가 한다. (개정 2017.5.23.)"
        },
        {
          id: "19",
          title: "제19조(규정의 공표)",
          content: "이 규정은 회사의 홈페이지에 공표한다. 규정을 개정한 때에도 또한 같다."
        }
      ]
    }
  ];
    ...
    <div className="bg-white">
      ...
      <section className="section-padding container-default">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-h2 mb-4 tracking-tight">내부정보관리규정</h2>
          ...
          <div className="space-y-16">
                      ...
                      <div className="text-body-m text-gray-700 leading-relaxed space-y-3 pl-4 border-l-2 border-gray-50 group-hover:border-gray-200 transition-colors">
                        {Array.isArray(article.content) ? (
                          article.content.map((p, i) => (
                            <p key={i} className={p.startsWith('※') ? 'text-sm text-gray-500 italic mt-2' : ''}>
                              {p}
                            </p>
                          ))
                        ) : (
            ...
            >
              <div className="bg-gray-50 p-8 rounded-2xl">
                ...
                <p className="text-body-m text-gray-700">이 규정은 2025년 9월 25일부터 시행한다.</p>
              </div>
              <p className="mt-12 text-center text-gray-400 text-sm">
                본 규정은 회사의 투명성과 신뢰성을 높이기 위해 제정되었으며, 모든 임직원은 이를 철저히 준수해야 합니다.
              </p>
            </motion.div>
          </div>
        </div>

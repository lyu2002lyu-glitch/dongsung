    ...
    <div className="bg-white">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="prose prose-gray max-w-none text-gray-600 font-light text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">1. 설치 근거 및 목적</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">2. 설치 대수, 설치 위치 및 촬영범위</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">3. 관리책임자</h2>
          <div className="overflow-x-auto mb-12 border-t border-black">
            <table className="w-full border-collapse text-[11px] uppercase tracking-widest">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">4. 영상정보 처리 및 관리</h2>
          <p className="mb-6 font-bold text-black">o 동승은 영상정보를 아래와 같이 처리 및 관리하고 있습니다.</p>
          <div className="overflow-x-auto mb-4 border-t border-black">
            <table className="w-full border-collapse text-[11px] uppercase tracking-widest">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">5. 영상정보 위탁</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">6. 영상정보의 파기</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">7. 영상정보의 확인 방법</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">8. 영상정보 열람 등 요구에 대한 조치</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">9. 영상정보 안정성을 위한 노력</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">10. 영상정보 처리방침 변경</h2>

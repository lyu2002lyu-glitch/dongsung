  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="prose prose-gray max-w-none text-gray-600 font-light text-sm leading-relaxed">
          
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">1. 개인정보처리방침 의의</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">2. 수집하는 개인정보</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">3. 개인정보의 이용</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">4. 개인정보의 제공과 위탁</h2>
          <ul className="list-disc pl-5 mb-8 space-y-3">
          ...
          <div className="overflow-x-auto mb-12 border-t border-black">
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">5. 개인정보의 파기</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">6. 이용자 권리와 행사방법</h2>
          <ul className="list-disc pl-5 mb-8 space-y-3">
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">7. 개인정보보호를 위한 노력</h2>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">8. 개인정보 보호책임자 및 담당자 안내</h2>
          <p className="mb-6 font-bold text-black">o 동승은 이용자의 개인정보 관련 문의사항 및 불만 처리 등을 위해 아래와 같이 개인정보 보호 책임자 및 담당자를 지정하고 있습니다.</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-gray-100 mb-12">
            <div className="p-10 border-r border-gray-100 last:border-r-0 bg-gray-50">
              <h3 className="font-bold text-sm mb-8 text-black uppercase tracking-widest border-b border-gray-200 pb-4">개인정보 보호담당자</h3>
            ...
            <div className="p-10 border-r border-gray-100 last:border-r-0 bg-gray-50">
              <h3 className="font-bold text-sm mb-8 text-black uppercase tracking-widest border-b border-gray-200 pb-4">개인정보 보호책임자</h3>
              <div className="space-y-2 text-gray-500 font-light">
                <p>이 름 : 이상식</p>
                <p>전화 : 02-2262-0312</p>
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">9. 개인정보 자동수집 장치(쿠키)의 설치, 운영 및 그 거부에 관한 사항</h2>
          <ul className="list-disc pl-5 mb-12 space-y-3">
          ...
          <h2 className="text-xl font-bold text-black mb-8 tracking-tight">10. 개인정보 처리방침 변경</h2>
